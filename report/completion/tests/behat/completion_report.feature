...
Feature: See the completion for items in a course
  ...
  @javascript
  Scenario: User course profile links to filtered course completion report (MDL-72241)
    Given I log in as "teacher1"
    And I am on "Course 1" course homepage
  ...
  @javascript
  Scenario: User course completion report lists exactly the expected user (MDL-72241)
    Given I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I navigate to "Course completion" in current page administration
    And I expand all fieldsets
