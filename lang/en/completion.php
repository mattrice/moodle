...
$string['eventcoursecompletionoptionsunlocked'] = 'Course completion options unlocked';
$string['eventcoursecompletionoptionsunlockeddesc'] = 'The user with id \'{$a->userid}\' unlocked the course completion options, and deleted existing user completion data, for course with id \'{$a->courseid}\'.';
